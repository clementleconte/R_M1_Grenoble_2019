...
df %>%
  ...
  summarize(max_retard = max(dep_delay, na.rm = T)) %>% 
...
> combien de vols qui partent des trois aéroport de NY atterrsient dans des destinations au dessus de 1000m s.n.m.?
