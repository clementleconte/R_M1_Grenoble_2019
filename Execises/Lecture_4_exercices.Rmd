...
```{r ex2}
#1 dire à gather quelles variables reuceillir

table4b %>% 
  gather('1999','2000',key = year, value = population)

# OU, dire à gather les variables qu'on ne veut pas recueillir
...
# OU dire  gather qu'on ne veut pas recueillir
table1 %>% 
...
```{r ex4}
#ça marche pas mais le code est bon
wbp <- world_bank_pop
...
df %>% 
  ...
  ggplot(aes(x = year, y = prop, color = name))+geom_line()+facet_grid(name~sex) 
```
